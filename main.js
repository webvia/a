...
// Page -------------------------------------------------------------------------------------------------------------
function Page() {
u_page = ''; u_item = ''; u_path_pre = ''; doc_body.innerHTML = ''; // reset vars
...
// Html -------------------------------------------------------------------------------------------------------------
function Html() {
doc_body.insertAdjacentHTML('afterbegin', html);

// links --------------------------------------------
var lnks = doc_body.getElementsByTagName('a'); var lnks_len = lnks.length; for (var i1 = 0; i1 < lnks_len; i1++) { 
var lnk = lnks[i1];
