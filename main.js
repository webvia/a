...
doc_body.insertAdjacentHTML('afterbegin', '<div id="e-_all"></div>');
var e_all = doc_body.querySelector('div#e-_all');
...
// Page -------------------------------------------------------------------------------------------------------------
function Page() {
u_page = ''; u_item = ''; u_path_pre = ''; e_all.innerHTML = ''; // reset vars
...
// Html -------------------------------------------------------------------------------------------------------------
function Html() {
e_all.insertAdjacentHTML('afterbegin', html);

// links --------------------------------------------
var lnks = e_all.getElementsByTagName('a'); var lnks_len = lnks.length; for (var i1 = 0; i1 < lnks_len; i1++) { 
var lnk = lnks[i1];
