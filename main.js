...
if ( HasVal(u_def) && (u_def.includes('.')) ) { var u_def_x = u_def } else { var u_def_x = 'https://docs.google.com/spreadsheets/d/'+ u_def +'/gviz/tq?tqx=out:csv&gid=0&headers=0&tq=select+%2A' } 
