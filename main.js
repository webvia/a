...
// setup html
doc_body.insertAdjacentHTML('afterbegin', '<div id="e-_page"></div>');
var e_page = doc_body.querySelector('div#e-_page');
...
// Page -------------------------------------------------------------------------------------------------------------
function Page() {
u_page = ''; u_item = ''; u_path_pre = ''; e_page.innerHTML = ''; // reset vars
...
// html body(page(header,middle(left,center(top,main,bottom),right),footer))
...
// links --------------------------------------------
var lnks = e_page.getElementsByTagName('a'); var lnks_len = lnks.length; for (var i1 = 0; i1 < lnks_len; i1++) { 
var lnk = lnks[i1];
